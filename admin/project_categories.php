...
if (isset($_POST['add'])) {
    ...
    $result = $project->addCategory($category);
...
if (isset($_POST['edit'])) {
    ...
    // passing login information
    $result = $project->editCategory($id, $category);
...
if (isset($_GET['del_id'])) {
    ...
    $result = $project->deleteCategory($id);
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <strong class="mb-1">Project Categories</strong><span class="dot dot-lg bg-success ml-1"></span>
                                        <p class="small text-muted mb-1">This shows all project categories. For new category click the new category button.</p>
                                    </div>
                                        ...
                                        <table class="table datatables" id="dataTable-1">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($row as $rw) {
                                                    ...
                                                    $blogs = $project->countprojectAndCategory($cat_id);
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item text-danger" href="project_categories.php?del_id=<?php echo $rw['category_id'] ?>">Remove</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
