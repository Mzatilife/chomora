                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <strong class="mb-1">Upload Project</strong><span class="dot dot-lg bg-success ml-1"></span>
                                        <p class="small text-muted mb-1">This shows all Projects that have been uploaded. For new project click the upload new button.</p>
                                    </div>
                                    <div class="col-4 col-md-auto offset-4 offset-md-0 my-2">
                                        <a href="upload_project.php" class="btn btn-sm btn-info">upload new</a>
                                    </div>
                                </div>
                            </div> <!-- / .card-body -->
                        </div> <!-- / .card -->
