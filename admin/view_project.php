...
$row = $project->viewprojectById($view);

// $comments = $project->countComments($view);

if (isset($_GET['del_id'])) {
    $id = $_GET['del_id'];
    $result = $project->deleteComment($id);
                        ...
                        <div class="col-lg-12">
                            <div class="single-post">
                                <div class="project_details">
                                    <img class="float-left mr-3 img-thumbnail img-responsive" style="max-height: 200px;" src="../img/project/<?php echo $row['image']; ?>" alt="image">
                                    <h3>
                                        <?php echo $row['title']; ?>
                                    </h3>
                            ...
                            <!-- <div class="panel panel-default widget">
                                ...
                                <div class="panel-body">
                                    <ul class="list-group">
                                        ...
                                        $com = $project->viewComments($view, $page1, 4);
                                        foreach ($com as $rw) {
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-10 col-md-11">
                                                        ...
                                                        <div class="action">
                                                            <a href="view_project?del_id=<?php echo $rw['comment_id'] ?>" type="button" class="btn btn-danger btn-sm" title="Delete">
                                        ...
                                        <?php }
                                        $cout = $project->countComments($view);
                                        ...
                                        <div class="btn-group mr-2" role="group" aria-label="First group">
                                            <?php for ($b = 1; $b <= $a; $b++) {  ?>
                                                <a href="view_project.php?page=<?php echo $b; ?>" class="btn mb-2 btn-secondary"><?php echo $b; ?></a>
                                            <?php } ?>
                                        </div>
                                    </ul>
                                </div>
