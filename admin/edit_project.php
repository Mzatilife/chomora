...
$row = $project->viewprojectById($edit);

if (isset($_POST['submit'])) {

    unlink("../img/project/" . $row['image']);
    ...
    $project_id = TestInput($_POST['project_id']);
    ...
    if (in_array($file_extension, $valid_ext)) {
        ...
        $result = $project->editproject($cat, $title, $author, $new_name, $content, $sdate, $edate, $project_id);
        if ($result) {
            $msg = "project edited";
            header('refresh:2, url=edit_project.php');
        } else {
            $msg2 = "Error, couldn't edit the project";
        }
    } else {
                                ...
                                <form class="needs-validation" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <div class="row">
                                                <img src="../img/project/<?php echo $row['image'] ?>" class="col-4" width="100%" height="50px" alt="">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 mb-3">
                                            ...
                                            <input type="date" name="sdate" class="form-control" id="date-input1" value="<?php echo $row['start_date']; ?>" aria-describedby="button-addon2" required>
                                            <div class="valid-feedback"> Looks good! </div>
                                            <div class="invalid-feedback"> Please insert a date!</div>
                                        </div>
                                        <div class="form-group col-md-6 mb-3">
                                            <label for="date-input1">End Date *</label>
                                            <input type="date" name="edate" class="form-control" id="date-input1" value="<?php echo $row['end_date']; ?>" aria-describedby="button-addon2" required>
                                            <div class="valid-feedback"> Looks good! </div>
                                            <div class="invalid-feedback"> Please insert a date!</div>
                                        </div>
                                    </div> <!-- /.form-row -->
                                    ...
                                    <input type="number" value="<?php echo $row['project_id'] ?>" name="project_id" hidden>
