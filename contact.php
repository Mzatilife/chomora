			...
			<section class="awe-section bg-photo">
				<div class="container">
					...
					<div class="page-title pb-40">
						<h2 class="page-title__title" style="color: #E0E1E4;">Get in touch</h2>
						<p class="page-title__text">Send me a message, will get back to you as soon as I can.</p>
					...
					<div class="row">
						<div class="col-md-4 col-lg-3 ">
							...
							<div class="contact">
								...
								<div class="contact__text">Zomba, Malawi</div>
							</div><!-- End / contact -->
							...
							<div class="contact">
								...
								<div class="contact__text">+265 992 98 51 76, +265 888 28 58 51</div>
							</div><!-- End / contact -->
							...
							<div class="contact">
								...
								<div class="contact__text"><a href="mailto:dsti@education.gov.mw">dsti@education.gov.mw</a></div>
							</div><!-- End / contact -->
